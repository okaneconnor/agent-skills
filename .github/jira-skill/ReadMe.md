...
The Atlassian MCP Server connects Copilot to your Jira board via OAuth — no API tokens or credentials required.
...
Copilot will draft a story using the skill's template, present it for your approval, and then post it to Jira via MCP.
